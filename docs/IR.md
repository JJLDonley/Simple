...
- SIR text parser/lowerer: `source/IR/src/ir_lang.cpp`
- Bytecode builder/fixups: `source/IR/src/ir_builder.cpp`
- SBC compiler/packer: `source/IR/src/ir_compiler.cpp`
- Public headers: `source/IR/include/ir_lang.h`, `source/IR/include/ir_builder.h`, `source/IR/include/ir_compiler.h`
...
| ✅ | module | `sir version <major>.<minor>` | Explicit SIR version directive; current supported version is `3.5`. | SBC version/metadata |
