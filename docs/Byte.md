...
SBC metadata rows are compact little-endian POD-style records defined in `source/Byte/include/sbc_types.h`. Section table entries identify each section by id, byte offset, byte size, and row count.
