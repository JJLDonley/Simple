...
- Enum-backed library catalog boundary in `source/Library/include/library_catalog.h`.
...
- Legacy name helpers quarantined in `source/Library/src/library_legacy.cpp`.
