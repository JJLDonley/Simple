...
- [x] Consolidate VM/native slot packing, reference/null decoding, and float conversion in the existing `runtime/values.h` ABI boundary.
...
- `source/Lang/src/lang_sir.cpp`
- `source/Lang/src/lang_validate.cpp`
- `source/LSP/src/lsp_server.cpp`
- `source/VM/src/jit/llvm_backend.cpp`
- `source/VM/src/vm.cpp`
- `source/Byte/src/sbc_verifier.cpp`
...
- `source/LSP/src/library_lsp.cpp` for library completions/hover/signature helpers.
- `source/Lang/src/SIR/library_lowering.cpp` for library/reserved call lowering.
- `source/Lang/src/Validate/library_validate.cpp` for library/reserved call validation.
- `source/Byte/src/verifier/resource_verifier.cpp` once resource-kind verifier work begins.
