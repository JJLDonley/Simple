...
Tagged class trace descriptors identify payload reference fields precisely.
...
owning class while live. Dereference and store trap on zero, stale, foreign,
