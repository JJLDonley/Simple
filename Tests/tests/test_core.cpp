...
bool RunOpcodeOperandWidthMetadataTest() {
  ...
  return !Simple::Byte::GetOperandWidth(0x17, &width);
}
...
bool RunOpcodeTypeRuleMetadataTest() {
  ...
  return !Simple::Byte::GetOpTypeRule(0x17, &rule);
}
...
bool RunOpcodeControlFlowMetadataTest() {
  ...
  return !Simple::Byte::GetOpControlFlow(0x17, &flow);
}
...
bool RunOpcodeVerifierRuleMetadataTest() {
  ...
  return !Simple::Byte::GetOpVerifierRule(0x17, &rule);
}
...
bool RunOpcodeVmDispatchMetadataTest() {
  ...
  return !Simple::Byte::GetOpVmDispatch(0x17, &dispatch);
}
