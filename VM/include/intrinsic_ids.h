...
constexpr uint32_t kIntrinsicStrI32 = 0x0061u;
constexpr uint32_t kIntrinsicStrI64 = 0x0062u;
constexpr uint32_t kIntrinsicStrU32 = 0x0063u;
constexpr uint32_t kIntrinsicStrU64 = 0x0064u;
constexpr uint32_t kIntrinsicStrF32 = 0x0065u;
constexpr uint32_t kIntrinsicStrF64 = 0x0066u;
constexpr uint32_t kIntrinsicStrBool = 0x0067u;
