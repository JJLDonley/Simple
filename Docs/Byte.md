...
| ✅ | `TypeRow` | `name_str`, `kind`, `flags`, `reserved`, `size`, `field_start`, `field_count`; flag `0x1` marks managed artifact layout, flag `0x2` marks stable data layout, flag `0x4` marks opaque handle layout and stores stable native resource kind id in `reserved`; verifier treats opaque handles as packed 64-bit handle words |
...
| ✅ | ext `23` | `CheckedArrayGetI64` | 0 | 2 | 1 |
| ✅ | ext `24` | `CheckedArraySetI64` | 0 | 3 | 0 |
| ✅ | ext `25` | `CheckedArrayGetF32` | 0 | 2 | 1 |
| ✅ | ext `26` | `CheckedArraySetF32` | 0 | 3 | 0 |
| ✅ | ext `27` | `CheckedArrayGetF64` | 0 | 2 | 1 |
| ✅ | ext `28` | `CheckedArraySetF64` | 0 | 3 | 0 |
| ✅ | ext `29` | `CheckedArrayGetRef` | 0 | 2 | 1 |
...
| ✅ | ext `35` | `CheckedListGetF32` | 0 | 2 | 1 |
| ✅ | ext `36` | `CheckedListSetF32` | 0 | 3 | 0 |
| ✅ | ext `37` | `CheckedListGetF64` | 0 | 2 | 1 |
