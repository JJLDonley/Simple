...
void IrBuilder::EmitJmpTable(const std::vector<IrLabel>& cases, IrLabel default_label) {
  ...
  Simple::Byte::sbc::AppendU32(blob, static_cast<uint32_t>(cases.size()));
  for (size_t i = 0; i < cases.size(); ++i) {
    Simple::Byte::sbc::AppendU32(blob, 0);
  }
...
void IrBuilder::EmitNewArrayI64(uint32_t type_id, uint32_t length) {
  EmitOp(OpCode::NewArrayI64);
  EmitU32(type_id);
  EmitU32(length);
}

void IrBuilder::EmitNewArrayF32(uint32_t type_id, uint32_t length) {
  EmitOp(OpCode::NewArrayF32);
  EmitU32(type_id);
  EmitU32(length);
}
...
void IrBuilder::EmitNewArrayRef(uint32_t type_id, uint32_t length) {
  EmitOp(OpCode::NewArrayRef);
  EmitU32(type_id);
  EmitU32(length);
}
...
void IrBuilder::EmitArrayFill() {
  EmitOp(OpCode::ArrayFill);
}
...
void IrBuilder::EmitNewListI64(uint32_t type_id, uint32_t capacity) {
  EmitOp(OpCode::NewListI64);
  EmitU32(type_id);
  EmitU32(capacity);
}

void IrBuilder::EmitNewListF32(uint32_t type_id, uint32_t capacity) {
  EmitOp(OpCode::NewListF32);
  EmitU32(type_id);
  EmitU32(capacity);
}
...
void IrBuilder::EmitListReserve() {
...
void IrBuilder::EmitNegF32() {
  EmitOp(OpCode::NegF32);
}

void IrBuilder::EmitNegF64() {
  EmitOp(OpCode::NegF64);
}

void IrBuilder::EmitNegI8() {
  EmitOp(OpCode::NegI8);
}

void IrBuilder::EmitNegI16() {
  EmitOp(OpCode::NegI16);
}

void IrBuilder::EmitNegU8() {
  EmitOp(OpCode::NegU8);
}

void IrBuilder::EmitNegU16() {
  EmitOp(OpCode::NegU16);
}

void IrBuilder::EmitNegU32() {
  EmitOp(OpCode::NegU32);
}

void IrBuilder::EmitNegU64() {
  EmitOp(OpCode::NegU64);
}
...
void IrBuilder::EmitIncF32() {
  EmitOp(OpCode::IncF32);
}

void IrBuilder::EmitDecF32() {
  EmitOp(OpCode::DecF32);
}

void IrBuilder::EmitIncF64() {
  EmitOp(OpCode::IncF64);
}

void IrBuilder::EmitDecF64() {
  EmitOp(OpCode::DecF64);
}

void IrBuilder::EmitIncU32() {
  EmitOp(OpCode::IncU32);
}

void IrBuilder::EmitDecU32() {
  EmitOp(OpCode::DecU32);
}

void IrBuilder::EmitIncU64() {
  EmitOp(OpCode::IncU64);
}

void IrBuilder::EmitDecU64() {
  EmitOp(OpCode::DecU64);
}

void IrBuilder::EmitIncI8() {
  EmitOp(OpCode::IncI8);
}

void IrBuilder::EmitDecI8() {
  EmitOp(OpCode::DecI8);
}

void IrBuilder::EmitIncI16() {
  EmitOp(OpCode::IncI16);
}

void IrBuilder::EmitDecI16() {
  EmitOp(OpCode::DecI16);
}

void IrBuilder::EmitIncU8() {
  EmitOp(OpCode::IncU8);
}

void IrBuilder::EmitDecU8() {
  EmitOp(OpCode::DecU8);
}

void IrBuilder::EmitIncU16() {
  EmitOp(OpCode::IncU16);
}

void IrBuilder::EmitDecU16() {
  EmitOp(OpCode::DecU16);
}
